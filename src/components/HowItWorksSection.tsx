...
const HowItWorksSection = () => {
  ...
  return (
    <section ref={ref} className="py-24 px-4 bg-secondary/50 pb-[74px] pt-[25px]">
      <div className="max-w-6xl mx-auto">
        ...
        >
          <h2 className="font-display text-3xl sm:text-4xl md:text-[3.25rem] font-bold text-foreground mb-4 leading-tight">
        ...
        <div className="relative">
          ...
          <motion.div
            ...
            className="hidden md:block absolute top-16 left-[12.5%] right-[12.5%] h-px bg-gradient-to-r from-border via-primary/40 to-border origin-left"
          />
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 md:gap-6">
            {steps.map((step, i) => (
              ...
              >
                <div className="relative z-10 flex items-center justify-center w-14 h-14 rounded-2xl bg-card border-2 border-primary/20 shadow-sm mb-5 group-hover:border-primary/40 group-hover:shadow-md group-hover:shadow-primary/10 transition-all duration-300">
