...
const HeroSection = () => {
  ...
  return (
    <section
      ref={ref}
      className="relative min-h-screen flex flex-col items-center justify-center pt-[55px] px-4 overflow-hidden pb-[5px]">
      ...
      <div className="relative z-10 max-w-4xl mx-auto text-center pt-[2px] py-0 pb-0">
        ...
        <motion.div
          ...
          className="flex flex-wrap items-center justify-center gap-4 sm:gap-6 text-sm text-muted-foreground my-0 pt-px mb-[27px] mt-[24px]">
